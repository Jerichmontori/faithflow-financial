  ...
  head: () => ({
    meta: [
      ...
      { title: "BUMOTIK FINANCIAL — Manajemen Keuangan Gereja" },
      {
        name: "description",
        content:
          "Sistem manajemen keuangan dan administrasi gereja: kas realtime, mata anggaran, dan approval pengeluaran.",
      },
      { property: "og:title", content: "BUMOTIK FINANCIAL — Manajemen Keuangan Gereja" },
      {
        property: "og:description",
        content: "Kelola kas, mata anggaran, dan approval pengeluaran jemaat dalam satu sistem.",
      },
